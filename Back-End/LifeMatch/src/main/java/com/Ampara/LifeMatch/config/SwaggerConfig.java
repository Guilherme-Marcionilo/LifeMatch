package com.Ampara.LifeMatch.config;
...
public class SwaggerConfig {
	...
	("com.Ampara.LifeMatch.controller") )
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("LifeMatch").description("API do Projeto integrador LifeMatch").version("1.0")
